...
plt.title("Scatter Plot: Total Businesses vs Specific Businesses (Software Design and Manufacturing)")
plt.xlabel("Total Businesses")
plt.ylabel("Specific Businesses (Software Design and Manufacturing)")
plt.show()
