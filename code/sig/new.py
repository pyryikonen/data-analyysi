...
plt.title("Scatter Plot: Total Businesses vs Specific Businesses (Software Design and Production)")
plt.xlabel("Total Businesses")
plt.ylabel("Specific Businesses (Software Design and Production)")
plt.show()
...
# Conclusion based on p-value and correlation
if p_value < 0.05:
    print("The relationship between total businesses and specific businesses is statistically significant.")
else:
    print("The relationship between total businesses and specific businesses is not statistically significant.")
